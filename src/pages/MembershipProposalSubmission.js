    ...
    return (
      <Grid.Row className="asset_field_row">
        ...
        <Grid.Column
          ...
          tablet={1}
          computer={2}
          className="asset_field_grid mobile_delete_icon"
          textAlign="right"
        >
        ...
        <Grid.Column
          ...
          tablet={1}
          computer={2}
          className="asset_field_grid computer_delete_icon"
          textAlign="center"
        >
          <div className="subtext">
            <Icon
...
export default class MembershipProposalSubmission extends Component {
  ...
  validateField(fieldName, value) {
    ...
    switch (fieldName) {
      ...
      case "shares":
        sharesValid = value > 0;
        fieldValidationErrors.shares = sharesValid
          ? ""
          : "Shares field is invalid";
        break;
      default:
        break;
    }
